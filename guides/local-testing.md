...
While we do not provide a local development environment with the full capabilities of the The Platform platform, you can use the following to test that your application builds and will run.
