...
**Apple OSX**
  * Strongswan OSX Client for OSX 10.7+
...
# OS X 10.7+ IKEv2 Strongswan Client Setup

This connection method has had the most success on OSX.
...
## Download the Strongswan OSX Application

The Strongswan VPN Client is available for OSX here: https://download.strongswan.org/osx/strongswan-5.3.2-1.app.zip

Unzip the file and double-click the app. Authorize the application to install the helper service. After the helper service is installed, the Strongswan client adds an icon to the top toolbar on the screen.

![vpn_osx_strongswan_icon](../images/vpn_osx_strongswan_icon.png)

Click on the icon and choose "Add" to add the Catalyze VPN connection.

Fill in a name for the connection, as well as the Server Address and Username for the connection. Then hit ok.
