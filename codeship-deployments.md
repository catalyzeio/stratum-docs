...
- 2a. Here's an example command `catalyze -E "<your_env_alias>" deploy-keys add codeship ./ssh_key.pub app01`
...
- 3a. The git remote can be found in your initial environment provisioning emails with Datica support engineers or by running `git remote -v` from within your git repo after you've run the `catalyze associate` command with the CLI.
